...
@click.option(
    "--rounds", "-r", default=10, help="Number of rounds to play", type=int, show_default=True
)
def cli(video_id: int, cam_width: int, cam_height: int, debug: bool, rounds: int):
    ...
    window = GestureGameWindow(
        recognizer=recognizer, width=cam_width, height=cam_height, caption="Gesture Tracing Game"
    )
